...
function Life() {
  return <section className="life" id="life"><div className="life-shell"><div className="life-heading"><p className="section-kicker">LIFE &amp; INTERESTS</p><h2>我的生活与爱好</h2><p>把鼠标放到文件夹上，看看工作之外的我。</p></div><div className="interest-wall"><figure className="interest interest-wellness"><img src="/assets/life-stickers/wellness.png?v=20260906b" alt="抱着爱心的女孩贴纸" /><figcaption>保持热爱</figcaption></figure><figure className="interest interest-reading"><img src="/assets/life-stickers/reading.png?v=20260906b" alt="阅读的女孩贴纸" /><figcaption>阅读输入中</figcaption></figure><figure className="interest interest-badminton"><img src="/assets/life-stickers/badminton.png?v=20260906" alt="打羽毛球的女孩贴纸" /><figcaption>挥拍一下</figcaption></figure><figure className="interest interest-swimming"><img src="/assets/life-stickers/swimming.png?v=20260906" alt="游泳的女孩贴纸" /><figcaption>自在游弋</figcaption></figure><figure className="interest interest-hiking"><img src="/assets/life-stickers/hiking.png?v=20260906" alt="爬山的女孩贴纸" /><figcaption>向山而行</figcaption></figure></div></div></section>
}

function About() {
  return <section className="about section" id="about"><div className="about-copy"><p>我是大米，一名持续学习、持续书写的人。这里收纳我的行业观察、生活手记，以及关于工作的长期思考。</p><a href="mailto:hello@example.com" className="text-link">认识一下 <Arrow /></a></div></section>
}
